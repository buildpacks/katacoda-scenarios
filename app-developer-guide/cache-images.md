...
To build an the `localhost:5000/buildpack-examples/cache-image-example` application image
...
> **NOTE:**  Please omit `--network host` if you are using a remote registry or on Windows.
